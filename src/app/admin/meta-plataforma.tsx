...
import { definirMetaPlataforma } from "./actions";

// Mesmo padrão do MetaMensalCard do Painel do revendedor — fica embutida no
// card de destaque do topo do Painel Admin, por isso não tem Card próprio.
export function MetaPlataformaCard({
  meta,
  receitaAtual,
  diasRestantes,
}: {
  ...
  function salvar() {
    ...
    iniciarTransicao(async () => {
      await definirMetaPlataforma(numero);
      setMetaAtual(numero);
      setEditando(false);
    });
  }
  ...
  if (editando) {
    return (
      <div className="flex flex-col gap-2">
        ...
        <p className="text-xs text-text-dim">Defina um alvo de receita líquida de assinaturas pra acompanhar o progresso aqui.</p>
