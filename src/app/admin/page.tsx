...
export default async function AdminPainelPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <h2 className="mb-3 text-sm font-bold text-text">Receita por mês</h2>
      ...
      <div>
        <p className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-text-dim">Contas e créditos</p>
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
          <Card className="overflow-x-auto p-0">
            <div className="flex items-center justify-between border-b border-border p-4">
              <h2 className="text-sm font-bold text-text">Contas</h2>
              <span className="text-xs text-text-dim">{contas.length} revendedor{contas.length === 1 ? "" : "es"}</span>
            </div>
